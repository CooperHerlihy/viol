...
-- at runtime using the environment variable viol_bindir.
...
-- environment variable viol_libdir.
...
-- using the environment variable viol_dynlibdir.
...
-- runtime using the environment variable viol_datadir.
...
-- using the environment variable viol_sysconfdir.
...
getLibDir     = catchIO (getEnv "viol_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "viol_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "viol_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "viol_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "viol_sysconfdir") (\_ -> return sysconfdir)
