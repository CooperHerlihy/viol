...
/* package viol-0.1.0.0 */
#ifndef VERSION_viol
#define VERSION_viol "0.1.0.0"
#endif /* VERSION_viol */
#ifndef MIN_VERSION_viol
#define MIN_VERSION_viol(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_viol */
...
#define CURRENT_COMPONENT_ID "viol-0.1.0.0-inplace-viol"
